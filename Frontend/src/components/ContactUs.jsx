...
export default function ContactUs() {
    return (
      ...
      <div className="  container bg-primary relative  text-white md:p-12 py-2 px-3 rounded-2xl flex flex-col md:flex-row items-center md:justify-between   mx-auto">
        <div className=" ">
