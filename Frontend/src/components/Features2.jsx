...
const Features = () => {
  return (
    <section className="absolute left-1/2 top-full -translate-x-1/2 -translate-y-1/2 w-11/12 max-w-6xl grid grid-cols-1 md:grid-cols-4 bg-white shadow-lg rounded-lg overflow-hidden">
      {/* Working Time */}
