...
const Features = () => {
  return (
    <section className="container mx-auto px-2 md:grid grid-cols-1 md:grid-cols-4 gap-2 shadow-lg rounded-lg">
      {/* Working Time */}
      <div className="bg-primary text-white md:p-6 p-3 mb-1 md:block hidden">
