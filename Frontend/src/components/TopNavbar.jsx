      ...
      <header className="  bg-primary text-white">
        <div className="  container mx-auto flex justify-between md:gap-0 gap-4 items-center py-2 px-4"  >
          ...
          <div className="flex items-center space-x-6">
            <a href="mailto:info@drrahulneurosurgeon.com" title="Email" aria-label='email' className="lg:flex hidden items-center space-x-2 hover:cursor-pointer hover:scale-x-105 ease-in-out transition-all duration-500">
              <i className="fas fa-envelope"></i>
              <span>info@drrahulneurosurgeon.com</span>
            </a>
            <a href="tel:+911234567890" title="Contact of Landmark Hospital" aria-label="Contact" className="flex items-center space-x-2 hover:scale-x-105 ease-in-out transition-all duration-500">
              <i className="fa-solid fa-phone-volume text-white"></i>
              <span className="md:text-base text-xs line-clamp-1">987654321 </span>
            </a>
          </div>
