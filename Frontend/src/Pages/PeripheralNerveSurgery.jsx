  ...
  const services = [
    ...
    },
    {
      ...
      benefits: [
        "Quick recovery",
        "Pain relief",
        "Restored hand strength",
      ],
      procedures: [
        "Carpal tunnel release",
        "Cubital tunnel release",
        "Peripheral decompressions",
      ],
    },
    {
      id: 5,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50">
      ...
      <section className="py-12 bg-gray-100">
        <div className=" container mx-auto px-4 lg:px-8 text-center">
          ...
          <h2
            ...
            style={{ color: "#13335b" }}
          >
            Advanced <span style={{ color: "#3b628b" }}>Peripheral Nerve</span>{" "}
            Surgery Solutions
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto text-justify">
            From traumatic injuries to chronic nerve compression and tumors, we
            offer cutting-edge surgical and rehabilitation solutions for the best
            recovery outcomes.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <p
          ...
          style={{ color: "#c7d2fe" }}
        >
          Early treatment and specialized surgical care can restore function and
          improve your quality of life. Book your consultation today.
        </p>
        <button
