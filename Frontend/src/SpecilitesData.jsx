    ...
    details: [
      {
        ...
        description: [
          ...
          "Education on weight management and stress reduction techniques.",
          ...
          "A structured program that includes exercise, education, and counseling to improve heart health and recovery after a cardiac event.",
        ],
      },
      {
        ...
        description: [
          ...
          "Assessment of symptoms (e.g., chest pain, shortness of breath), risk factors (e.g., family history, lifestyle), and a physical exam to check for signs of heart disease.",
          "Diagnostic Tests:",
          ...
          "Risk Assessment:",
          "Tools and questionnaires to evaluate the likelihood of heart disease based on risk factors like age, gender, family history, and lifestyle choices.",
        ],
      },
      {
        ...
        description: [
          ...
          "Regular Exercise:",
          "Aim for at least 150 minutes of moderate-intensity aerobic activity each week, along with strength training exercises.",
          "Avoid Tobacco:",
          "Quit smoking and avoid exposure to secondhand smoke.",
          "Maintain a Healthy Weight:",
          "Achieve and maintain a healthy body weight to reduce the risk of hypertension and diabetes.",
          "Manage Stress:",
          "Practice stress-reduction techniques such as mindfulness, yoga, or meditation.",
          "Regular Health Screenings:",
          "Regular check-ups with a healthcare provider to monitor blood pressure, cholesterol levels, and other risk factors.",
          "Limit Alcohol Consumption:",
          "If consumed, limit alcohol to moderate levels (up to one drink per day for women and two drinks for men).",
          "Control Chronic Conditions:",
          "Effectively manage conditions such as diabetes, hypertension, and high cholesterol through medication and lifestyle changes.",
        ],
      },
    ],
    faqs: [
